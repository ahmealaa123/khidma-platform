...
import AgentOrderStatusManager from "./AgentOrderStatusManager";

type AgentOrderDetailsPageProps = {
  params: Promise<{
    id: string;
  }>;
};
...
export default async function AgentOrderDetailsPage({
  params,
}: AgentOrderDetailsPageProps) {
